...
== Description ==
In WordPress 3.2 the 'Search Engines Blocked' notification was moved to the Right Now box. This plugin displays the 'Search Engines Discouraged' (or any translation) notification in the WordPress Toolbar.
If you have any comments or questions, please use the [support forum](https://wordpress.org/support/plugin/search-engines-blocked-in-header/)
